...
public final class AVariavelAtributosAlt extends PAtributosAlt
{
    private PTipoPrimitivo _tipoPrimitivo_;
    private TId _id_;
    private PExp _valor_;

    public AVariavelAtributosAlt()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AVariavelAtributosAlt(
    ...
    {
        ((Analysis) sw).caseAVariavelAtributosAlt(this);
    }
